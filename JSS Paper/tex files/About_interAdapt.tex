...
The \pkg{interAdapt} \proglang{R} package contains an interactive web browser application, as well as a command line function which performs the same computations. The browser application is built on the \pkg{shiny} package \citep{shiny2013manual}, with the back-end calculations done in \proglang{R}.
