...
\pkg{interAdapt} compares the performance of trial designs with adaptive
...
Users can work interactively in the \proglang{R} console or via a user
friendly \pkg{shiny} application that requires no experience with the
...
For example, the results of the performance comparison may be written to
