...
bibFile<-read.bibtex('interAdapt_cite.bib')
...
In the remained of this section we give an overview of the relevant concepts and notation needed to understand and use EAGLE. A more detailed discussion of the theoretical context, and of the parameter calculation procedure, can be found in `r citep(bibFile[["Rosenblum2013AdaptMISTIE"]])`.
